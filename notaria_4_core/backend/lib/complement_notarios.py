...
def create_complemento_notarios(complemento_model) -> 'notariospublicos10.NotariosPublicos':
    ...
    try:
        date_obj = datetime.strptime(fecha_inst, "%Y-%m-%d").date()
    ...
    if adquiriente_cop_sc_list:
        datos_adquiriente = notariospublicos10.DatosAdquiriente(
            copro_soc_conyugal_e=complemento_model.datos_adquirientes[0].copro_soc_conyugal_e if complemento_model.datos_adquirientes else 'No',
    ...
    if enajenante_cop_sc_list:
        datos_enajenante = notariospublicos10.DatosEnajenante(
            copro_soc_conyugal_e=complemento_model.datos_enajenantes[0].copro_soc_conyugal_e if complemento_model.datos_enajenantes else 'No',
