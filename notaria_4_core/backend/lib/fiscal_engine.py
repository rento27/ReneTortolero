...
def calculate_retentions(rfc_receptor: str, subtotal: Decimal, iva_rate: Decimal = Decimal("0.16")) -> dict:
    ...
    if len(rfc_receptor.strip()) == 12:
        ...
        # IVA Retention: Direct application of the 10.6667% rate on Subtotal
        # This matches the XML analysis ($648.952428) which implies a fixed rate
        # rather than a 2/3 fraction of the IVA amount.
