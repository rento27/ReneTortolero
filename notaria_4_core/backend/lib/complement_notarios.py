...
def create_complemento_notarios(complemento_model) -> 'notariospublicos10.NotariosPublicos':
    ...
    adq_copro = complemento_model.datos_adquirientes[0].copro_soc_conyugal_e if complemento_model.datos_adquirientes else 'No'
    ...
    ena_copro = complemento_model.datos_enajenantes[0].copro_soc_conyugal_e if complemento_model.datos_enajenantes else 'No'
