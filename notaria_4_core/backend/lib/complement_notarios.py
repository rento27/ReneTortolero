...
def create_complemento_notarios(complemento_model) -> 'notariospublicos10.NotariosPublicos':
    ...
    # Determine the general copro_soc_conyugal_e flag for Adquiriente based on presence of cop_sc
    adq_copro_flag = 'Si' if adquiriente_cop_sc_list else 'No'

    if adquiriente_cop_sc_list:
        datos_adquiriente = notariospublicos10.DatosAdquiriente(
            copro_soc_conyugal_e=adq_copro_flag,
    ...
    # Determine the general copro_soc_conyugal_e flag for Enajenante based on presence of cop_sc
    ena_copro_flag = 'Si' if enajenante_cop_sc_list else 'No'

    if enajenante_cop_sc_list:
        datos_enajenante = notariospublicos10.DatosEnajenante(
            copro_soc_conyugal_e=ena_copro_flag,
